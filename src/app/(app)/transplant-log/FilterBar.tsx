...
export default function FilterBar({
  ...
  const [localGenus, setLocalGenus] = useState(genus);
  ...
  function applyFilters() {
    ...
    if (localGenus) params.set("genus", localGenus);
  ...
  return (
    <div className="bg-white p-4 rounded border shadow-sm space-y-3">
      ...
      <div>
        ...
        <select
          value={localGenus}
          onChange={(e) => setLocalGenus(e.target.value)}
          className="border p-2 rounded w-full"
        >
          <option value="">All</option>
          {genusOptions.map((g) => (
