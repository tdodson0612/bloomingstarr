...
export default async function EditOverheadExpensePage({
  ...
  return (
    <div className="p-6 max-w-2xl">
      <h1 className="text-2xl font-semibold mb-6">Edit Overhead Expense</h1>

      <form
        action={updateOverheadExpense.bind(null, params.id)}
        className="space-y-4"
      >
        {/* Date */}
        <div>
          ...
          <input
            ...
            defaultValue={
              record.expenseDate
                ? record.expenseDate.toISOString().slice(0, 10)
                : ""
            }
          />
        </div>
        ...
        <div className="flex gap-3 pt-4">
          ...
          {/* DELETE BUTTON */}
          <form
            action={deleteOverheadExpense.bind(null, record.id)}
            className="ml-auto"
          >
            <button
              type="submit"
