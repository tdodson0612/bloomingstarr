...
export default function FilterBar({
  ...
  const [localTreatmentType, setLocalTreatmentType] = useState(treatmentType);
  ...
  function applyFilters() {
    ...
    if (localTreatmentType) params.set("treatmentType", localTreatmentType);
    else params.delete("treatmentType");
  ...
  function clearFilters() {
    ...
    setLocalQuickRange("");
    startTransition(() => {
      router.push("/treatment-tracking");
    });
  }
